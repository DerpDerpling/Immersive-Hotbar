...
import derp.immersivehotbar.config.preview.ItemAnimationPreviewState;
import derp.immersivehotbar.config.preview.PreviewMode;
...
public final class ItemAnimationPreview implements ImageRenderer {
    ...
    private void renderPickupPopPreview(GuiGraphics gfx) {
        gfx.blitSprite(HOTBAR, 0, 0, 182, 24);
        ...
        gfx.blitSprite(HOTBAR_SELECTION, centerSlotIndex * 20 - 1, -1, 24, 24);
    ...
    private void renderSelectedScaleComparison(GuiGraphics gfx) {
        ...
        gfx.blitSprite(HOTBAR_SELECTION, rightSlotIndex * 20 - 1, -1, 24, 24);
    ...
    private void renderSingleSlot(GuiGraphics gfx) {
        gfx.blitSprite(HOTBAR, 0, 0, 182, 24);
        gfx.blitSprite(HOTBAR_SELECTION, 79, -1, 24, 24);
