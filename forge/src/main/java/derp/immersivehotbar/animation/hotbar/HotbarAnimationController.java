...
public final class HotbarAnimationController {
    ...
    public void prepareSlot(GuiGraphics context, int x, int y, Player player, ItemStack stack) {
    ...
    public void renderShrinkingItems(GuiGraphics context) {
    ...
    private void updateOffhand() {
        ...
        boolean changed = !ItemStack.isSameItem(stack, lastOffhandStack) || !ItemStack.isSameItemSameTags(stack, lastOffhandStack) || stack.getCount() != lastOffhandCount;
