...
import static derp.immersivehotbar.config.ImmersiveHotbarConfig.scaleTooltipOffset;
import static derp.immersivehotbar.config.ImmersiveHotbarConfig.tooltipYOffset;
import static derp.immersivehotbar.config.ImmersiveHotbarConfig.tooltipYOffsetEnabled;
...
public final class TooltipAnimationRenderer {
    ...
    public static int render(GuiGraphics graphics, Minecraft minecraft, TooltipAnimationState state, Component text, int x, int y, int width, int color, TooltipDraw draw) {
        ...
        int animatedColor = FastColor.ARGB32.color(alpha, FastColor.ARGB32.red(color), FastColor.ARGB32.green(color), FastColor.ARGB32.blue(color));
