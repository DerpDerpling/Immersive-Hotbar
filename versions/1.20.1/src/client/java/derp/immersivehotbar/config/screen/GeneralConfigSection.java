    ...
    public static ConfigCategory create(ConfigUtil.Context context) {
        ...
        return ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                        ...
                        .option(Option.<ImmersiveHotbarConfig.shouldShowBackground>createBuilder()
                                ...
                                .controller(o -> EnumControllerBuilder.create(o).enumClass(ImmersiveHotbarConfig.shouldShowBackground.class))
                                .binding(ImmersiveHotbarConfig.shouldShowBackground.DISABLED, () -> showBackground, v -> showBackground = v)
                                .build())
