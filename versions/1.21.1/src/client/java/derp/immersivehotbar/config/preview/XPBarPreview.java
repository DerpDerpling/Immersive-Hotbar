...
public final class XPBarPreview implements ImageRenderer {
    ...
    private void update(float dt) {
        ...
        while (iterator.hasNext()) {
            ...
            float det = Minecraft.getInstance().getTimer().getGameTimeDeltaTicks();
    ...
    private void renderXpBar(GuiGraphics gfx) {
        ...
        gfx.blitSprite(EXPERIENCE_BAR_BACKGROUND, x, y, 182, 5);

        int filled = (int) (animatedXpProgress * 183.0f);
        if (filled > 0) {
            gfx.blitSprite(EXPERIENCE_BAR_PROGRESS, 182, 5, 0, 0, x, y, filled, 5);
        }
