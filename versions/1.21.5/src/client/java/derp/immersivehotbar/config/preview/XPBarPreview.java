...
public final class XPBarPreview implements ImageRenderer {
    ...
    private void renderXpBar(GuiGraphics gfx) {
        ...
        gfx.blitSprite(RenderType::guiTextured, EXPERIENCE_BAR_BACKGROUND, x, y, 182, 5);

        int filled = (int) (animatedXpProgress * 183.0f);
        if (filled > 0) {
            gfx.blitSprite(RenderType::guiTextured, EXPERIENCE_BAR_PROGRESS, 182, 5, 0, 0, x, y, filled, 5);
        }
