...
public final class XPBarPreview implements ImageRenderer {
    ...
    private void renderXpBar(GuiGraphics graphics) {
        ...
        graphics.blitSprite(RenderType::guiTextured, EXPERIENCE_BAR_BACKGROUND, x, y, 182, 5);

        int filled = (int) (state.animatedProgress() * 183.0f);
        if (filled > 0) graphics.blitSprite(RenderType::guiTextured, EXPERIENCE_BAR_PROGRESS, 182, 5, 0, 0, x, y, filled, 5);
