...
public final class ItemAnimationPreview implements ImageRenderer {
    ...
    private void renderPickupPopPreview(GuiGraphics gfx) {
        ...
        gfx.blitSprite(RenderPipelines.GUI_TEXTURED, HOTBAR_SELECTION, centerSlotIndex * 20 - 1, -1, 24, 24);
    ...
    private void renderSelectedScaleComparison(GuiGraphics gfx) {
        ...
        gfx.blitSprite(RenderPipelines.GUI_TEXTURED, HOTBAR_SELECTION, rightSlotIndex * 20 - 1, -1, 24, 24);
