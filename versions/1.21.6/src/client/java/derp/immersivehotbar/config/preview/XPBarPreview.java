...
import static derp.immersivehotbar.animation.xp.XPAnimationRenderer.renderLevelText;
...
public final class XPBarPreview implements ImageRenderer {
    ...
    private static final ResourceLocation EXPERIENCE_BAR_PROGRESS = ResourceLocation.withDefaultNamespace("hud/experience_bar_progress");
    ...
    private void renderLevelText(GuiGraphics graphics, int barY) {
        ...
        XPAnimationRenderer.renderLevelText(graphics, minecraft.font, text, x, y, state, (drawX, drawY) -> {
            graphics.drawString(minecraft.font, text, drawX + 1, drawY, 0xFF000000, false);
            graphics.drawString(minecraft.font, text, drawX - 1, drawY, 0xFF000000, false);
            graphics.drawString(minecraft.font, text, drawX, drawY + 1, 0xFF000000, false);
            graphics.drawString(minecraft.font, text, drawX, drawY - 1, 0xFF000000, false);
            graphics.drawString(minecraft.font, text, drawX, drawY, 0xFF80FF20, false);
        });
    }
