...
public final class AnimatedTooltipPreview implements ImageRenderer {
    ...
    private static final Identifier DIAMOND_SWORD_ICON =
    ...
    private void renderHotbar(GuiGraphicsExtractor gfx) {
        ...
        gfx.blit(RenderPipelines.GUI_TEXTURED, DIAMOND_SWORD_ICON, 83, 35, 0, 0, 16, 16, 16, 16);
    }

    private void renderTooltip(GuiGraphicsExtractor gfx) {
        ...
        gfx.textWithBackdrop(minecraft.font, text, x, y, width, color);
