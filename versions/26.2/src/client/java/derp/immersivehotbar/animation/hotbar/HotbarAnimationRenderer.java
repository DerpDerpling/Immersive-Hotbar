...
public final class HotbarAnimationRenderer {
    ...
    public static void withItemScale(GuiGraphicsExtractor context, int x, int y, float scale, Runnable draw) {
        int centerX = x + 8;
        int centerY = y + 8;
    ...
    public static void drawSlotEffects(GuiGraphicsExtractor context, ItemStack stack, int x, int y, boolean selected) {
        drawBackground(context, x, y, selected);
        drawDurabilityGlow(context, stack, x, y);
    }

    public static void renderShrinkingItems(Minecraft minecraft, GuiGraphicsExtractor context, HotbarAnimationState state, float deltaSeconds) {
    ...
    private static void drawDurabilityGlow(GuiGraphicsExtractor context, ItemStack stack, int x, int y) {
    ...
    private static void drawBackground(GuiGraphicsExtractor context, int x, int y, boolean selected) {
